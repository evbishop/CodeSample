...
namespace CodeSample_Currencies.Currency
{
    ...
    public class CurrencyHelper : ScriptableObject
    {
        #region Singleton
        ...
        [field: SerializeField] public CurrencyInfo[] CurrencyInfos { get; private set; }

        public void Init() { }

        public CurrencyInfo GetInfo(CurrencyType currencyType)
            => CurrencyInfos.FirstOrDefault(info => info.CurrencyType == currencyType);
        ...
        public Dictionary<CurrencyType, int> GetEmptyWallet()
        {
            ...
            for (int i = 0; i < CurrencyInfos.Length; i++)
                result.Add(CurrencyInfos[i].CurrencyType, 0);
        ...
        public Dictionary<CurrencyType, int> GetAllCurrenciesDefaultWorth()
        {
            ...
            for (int i = 0; i < CurrencyInfos.Length; i++)
            {
                ...
                result.Add(currencyInfo.CurrencyType, currencyInfo.Worth);
            }
